...
```typescript
import type { ListShipments200ResponseDataInnerCarrierSettings } from '@zippendo/sdk'
...
} satisfies ListShipments200ResponseDataInnerCarrierSettings
...
const exampleParsed = JSON.parse(exampleJSON) as ListShipments200ResponseDataInnerCarrierSettings
