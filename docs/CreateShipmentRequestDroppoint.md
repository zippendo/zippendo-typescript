...
```typescript
import type { CreateShipmentRequestDroppoint } from '@zippendo/sdk'
...
} satisfies CreateShipmentRequestDroppoint
...
const exampleParsed = JSON.parse(exampleJSON) as CreateShipmentRequestDroppoint
