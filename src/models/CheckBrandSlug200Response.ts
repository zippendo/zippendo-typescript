 ...
 * 
 * @export
 * @interface CheckBrandSlug200Response
 */
export interface CheckBrandSlug200Response {
    /**
     * The slug that was checked
     * @type {string}
     * @memberof CheckBrandSlug200Response
     */
    slug: string;
    /**
...
/**
 * Check if a given object implements the CheckBrandSlug200Response interface.
 */
export function instanceOfCheckBrandSlug200Response(value: object): value is CheckBrandSlug200Response {
    if (!('slug' in value) || value['slug'] === undefined) return false;
    if (!('available' in value) || value['available'] === undefined) return false;
    return true;
}

export function CheckBrandSlug200ResponseFromJSON(json: any): CheckBrandSlug200Response {
    return CheckBrandSlug200ResponseFromJSONTyped(json, false);
}

export function CheckBrandSlug200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CheckBrandSlug200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function CheckBrandSlug200ResponseToJSON(json: any): CheckBrandSlug200Response {
    return CheckBrandSlug200ResponseToJSONTyped(json, false);
}

export function CheckBrandSlug200ResponseToJSONTyped(value?: CheckBrandSlug200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
