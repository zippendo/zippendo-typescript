...
```typescript
import type { SplitShipment201Response } from '@zippendo/sdk'

// TODO: Update the object below with actual values
const example = {
  "originalShipment": null,
  "newShipment": null,
} satisfies SplitShipment201Response
...
const exampleParsed = JSON.parse(exampleJSON) as SplitShipment201Response
