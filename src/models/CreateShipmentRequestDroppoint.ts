 ...
 * @export
 * @interface CreateShipmentRequestDroppoint
 */
export interface CreateShipmentRequestDroppoint {
    /**
     * Identifier of the selected service point.
     * @type {string}
     * @memberof CreateShipmentRequestDroppoint
     */
    id: string;
    /**
...
/**
 * Check if a given object implements the CreateShipmentRequestDroppoint interface.
 */
export function instanceOfCreateShipmentRequestDroppoint(value: object): value is CreateShipmentRequestDroppoint {
...
export function CreateShipmentRequestDroppointFromJSON(json: any): CreateShipmentRequestDroppoint {
    return CreateShipmentRequestDroppointFromJSONTyped(json, false);
}

export function CreateShipmentRequestDroppointFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateShipmentRequestDroppoint {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateShipmentRequestDroppointToJSON(json: any): CreateShipmentRequestDroppoint {
    return CreateShipmentRequestDroppointToJSONTyped(json, false);
}

export function CreateShipmentRequestDroppointToJSONTyped(value?: CreateShipmentRequestDroppoint | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
