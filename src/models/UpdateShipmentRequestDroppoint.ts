 ...
 */
export interface UpdateShipmentRequestDroppoint {
    /**
     * Identifier of the selected service point.
     * @type {string}
     * @memberof UpdateShipmentRequestDroppoint
     */
    id: string;
    /**
...
/**
 * Check if a given object implements the UpdateShipmentRequestDroppoint interface.
 */
export function instanceOfUpdateShipmentRequestDroppoint(value: object): value is UpdateShipmentRequestDroppoint {
...
export function UpdateShipmentRequestDroppointFromJSON(json: any): UpdateShipmentRequestDroppoint {
    return UpdateShipmentRequestDroppointFromJSONTyped(json, false);
}

export function UpdateShipmentRequestDroppointFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateShipmentRequestDroppoint {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateShipmentRequestDroppointToJSON(json: any): UpdateShipmentRequestDroppoint {
    return UpdateShipmentRequestDroppointToJSONTyped(json, false);
}

export function UpdateShipmentRequestDroppointToJSONTyped(value?: UpdateShipmentRequestDroppoint | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
