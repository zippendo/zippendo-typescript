...
```typescript
import type { UpdateShipmentRequestDroppoint } from '@zippendo/sdk'
...
} satisfies UpdateShipmentRequestDroppoint
...
const exampleParsed = JSON.parse(exampleJSON) as UpdateShipmentRequestDroppoint
