...
```typescript
import type { UpdateShippingRuleRequest } from '@zippendo/sdk'
...
const example = {
  ...
  "additionalParameters": {"returnFunctionality":"LABELLESS"},
...
} satisfies UpdateShippingRuleRequest
...
const exampleParsed = JSON.parse(exampleJSON) as UpdateShippingRuleRequest
