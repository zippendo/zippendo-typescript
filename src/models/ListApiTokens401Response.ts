 ...
 * 
 * @export
 * @interface ListApiTokens401Response
 */
export interface ListApiTokens401Response {
    /**
     * Machine-readable error code (translate by this on the client)
     * @type {ListApiTokens401ResponseCodeEnum}
     * @memberof ListApiTokens401Response
     */
    code?: ListApiTokens401ResponseCodeEnum;
    /**
     * Short human title
     * @type {string}
     * @memberof ListApiTokens401Response
 ...
 * @export
 */
export const ListApiTokens401ResponseCodeEnum = {
...
/**
 * Check if a given object implements the ListApiTokens401Response interface.
 */
export function instanceOfListApiTokens401Response(value: object): value is ListApiTokens401Response {
    if (!('error' in value) || value['error'] === undefined) return false;
    if (!('message' in value) || value['message'] === undefined) return false;
    return true;
}

export function ListApiTokens401ResponseFromJSON(json: any): ListApiTokens401Response {
    return ListApiTokens401ResponseFromJSONTyped(json, false);
}

export function ListApiTokens401ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListApiTokens401Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ListApiTokens401ResponseToJSON(json: any): ListApiTokens401Response {
    return ListApiTokens401ResponseToJSONTyped(json, false);
}

export function ListApiTokens401ResponseToJSONTyped(value?: ListApiTokens401Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
