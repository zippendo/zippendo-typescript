...
`orderLines` | [Array&lt;CreateShipment201ResponseParcelsInnerOrderLinesInner&gt;](CreateShipment201ResponseParcelsInnerOrderLinesInner.md)
...
```typescript
import type { CreateShipment201ResponseParcelsInner } from '@zippendo/sdk'
...
} satisfies CreateShipment201ResponseParcelsInner
...
const exampleParsed = JSON.parse(exampleJSON) as CreateShipment201ResponseParcelsInner
