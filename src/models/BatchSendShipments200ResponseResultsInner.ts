 ...
 * 
 * @export
 * @interface BatchSendShipments200ResponseResultsInner
 */
export interface BatchSendShipments200ResponseResultsInner {
    /**
 ...
 * @export
 */
export const BatchSendShipments200ResponseResultsInnerCodeEnum = {
    ...
    OrderChannelRatesOnly: 'ORDER_CHANNEL_RATES_ONLY',
    ...
    WmsConnectionNotFound: 'WMS_CONNECTION_NOT_FOUND',
    WmsConnectionConfigInvalid: 'WMS_CONNECTION_CONFIG_INVALID',
    WmsConnectionDisabled: 'WMS_CONNECTION_DISABLED',
    WmsAccountMismatch: 'WMS_ACCOUNT_MISMATCH',
    WmsHostIdUnmapped: 'WMS_HOST_ID_UNMAPPED',
    WmsServicePointRequired: 'WMS_SERVICE_POINT_REQUIRED',
    WmsDangerousGoodsUnsupported: 'WMS_DANGEROUS_GOODS_UNSUPPORTED',
    WmsLabelInProgress: 'WMS_LABEL_IN_PROGRESS',
    WmsLabelAlreadyBooked: 'WMS_LABEL_ALREADY_BOOKED',
    WmsLabelCountMismatch: 'WMS_LABEL_COUNT_MISMATCH',
...
/**
 * Check if a given object implements the BatchSendShipments200ResponseResultsInner interface.
 */
export function instanceOfBatchSendShipments200ResponseResultsInner(value: object): value is BatchSendShipments200ResponseResultsInner {
    if (!('shipmentId' in value) || value['shipmentId'] === undefined) return false;
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function BatchSendShipments200ResponseResultsInnerFromJSON(json: any): BatchSendShipments200ResponseResultsInner {
    return BatchSendShipments200ResponseResultsInnerFromJSONTyped(json, false);
}

export function BatchSendShipments200ResponseResultsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchSendShipments200ResponseResultsInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'errors': json['errors'] == null ? undefined : ((json['errors'] as Array<any>).map(SendShipment422ResponseErrorsInnerFromJSON)),
    };
}

export function BatchSendShipments200ResponseResultsInnerToJSON(json: any): BatchSendShipments200ResponseResultsInner {
    return BatchSendShipments200ResponseResultsInnerToJSONTyped(json, false);
}

export function BatchSendShipments200ResponseResultsInnerToJSONTyped(value?: BatchSendShipments200ResponseResultsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'errors': value['errors'] == null ? undefined : ((value['errors'] as Array<any>).map(SendShipment422ResponseErrorsInnerToJSON)),
    };
}
