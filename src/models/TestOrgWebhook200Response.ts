 ...
 * 
 * @export
 * @interface TestOrgWebhook200Response
 */
export interface TestOrgWebhook200Response {
    /**
     * Result message
     * @type {string}
     * @memberof TestOrgWebhook200Response
     */
    message: string;
}

/**
 * Check if a given object implements the TestOrgWebhook200Response interface.
 */
export function instanceOfTestOrgWebhook200Response(value: object): value is TestOrgWebhook200Response {
    if (!('message' in value) || value['message'] === undefined) return false;
    return true;
}

export function TestOrgWebhook200ResponseFromJSON(json: any): TestOrgWebhook200Response {
    return TestOrgWebhook200ResponseFromJSONTyped(json, false);
}

export function TestOrgWebhook200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TestOrgWebhook200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function TestOrgWebhook200ResponseToJSON(json: any): TestOrgWebhook200Response {
    return TestOrgWebhook200ResponseToJSONTyped(json, false);
}

export function TestOrgWebhook200ResponseToJSONTyped(value?: TestOrgWebhook200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
