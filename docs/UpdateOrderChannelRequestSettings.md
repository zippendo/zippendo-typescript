...
```typescript
import type { UpdateOrderChannelRequestSettings } from '@zippendo/sdk'
...
const example = {
  ...
  "servicePointCount": 6,
} satisfies UpdateOrderChannelRequestSettings
...
const exampleParsed = JSON.parse(exampleJSON) as UpdateOrderChannelRequestSettings
